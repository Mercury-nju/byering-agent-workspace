...
import { listHiredAgents, getMarketplaceAgent } from "../agents/marketplace.js";
import { assignMarketplaceAgent } from "../bridge/employment-client.js";
  ...
  function renderCreateForm() {
    ...
    submit.addEventListener("click", async () => {
      ...
      try {
        ...
        await Promise.all(hired
          .filter((agent) => form.members.has(agent.id))
          .map((agent) => assignMarketplaceAgent(agent.id, room.id)));
        // 负责人发出开工消息
