...
const CSS = `
.sb-ear{min-height:100%;padding:18px 22px 26px;background:var(--sb-app-page-bg,#f7f8fb);color:#20242b;font-family:-apple-system,"PingFang SC","Microsoft YaHei",sans-serif;box-sizing:border-box}
