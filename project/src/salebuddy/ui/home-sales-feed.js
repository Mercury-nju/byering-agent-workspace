...
const BYERING_LOGO_MARK_URL = new URL("../../../assets/byering-logo-mark.png", import.meta.url).href;
...
.sb-home-hero-lockup{display:inline-flex;align-items:center;gap:12px;width:auto;height:52px;overflow:visible;line-height:1}
.sb-home-hero-mark{display:block;width:52px;height:52px;border-radius:12px;object-fit:cover;flex:none}
.sb-home-hero-name{display:inline-block;color:#101319;font-size:clamp(26px,2vw,34px);font-weight:750;letter-spacing:0;line-height:1}
...
@media(max-width:1500px){
  ...
  .sb-home-hero-lockup{height:46px}.sb-home-hero-mark{width:46px;height:46px}.sb-home-hero-name{font-size:28px}.sb-home-hero-brand{left:12px;top:44%}.sb-home-hero-nav{left:12px;bottom:13px;height:40px;padding:0 9px}.sb-home-hero-nav-item{height:30px;padding:0 12px;gap:7px;font-size:14px}.sb-home-hero-nav-icon{font-size:18px}.sb-home-hero-bird{right:28px;bottom:-38px;width:230px;height:173px;border-radius:16px}.sb-home-hero-bubbles{right:0;transform:scale(.86);transform-origin:top right}
}
@media(max-width:1324px){
  ...
  .sb-home-hero-lockup{height:42px}.sb-home-hero-mark{width:42px;height:42px;border-radius:10px}.sb-home-hero-name{font-size:25px}.sb-home-hero-brand{left:12px;top:44%}.sb-home-hero-nav{left:12px;bottom:13px;height:40px;padding:0 9px}.sb-home-hero-nav-item{height:30px;padding:0 11px;gap:6px;font-size:13px}.sb-home-hero-nav-icon{font-size:17px}.sb-home-hero-bird{right:20px;bottom:-34px;width:225px;height:169px;border-radius:14px}.sb-home-hero-bubbles{right:0;transform:scale(.86);transform-origin:top right}
...
@media(max-width:680px){
  ...
  .sb-home-hero-brand{left:18px;top:44%}.sb-home-hero-lockup{height:36px;gap:8px}.sb-home-hero-mark{width:36px;height:36px;border-radius:9px}.sb-home-hero-name{font-size:22px}
...
const DOMAIN_WORKFLOW_CONTEXT = Object.freeze({
  sales: {
    ...
    agents: "账号发现与解析师负责身份解析，线索猎人负责公开数据采集，线索分析师负责意向评分，客户画像研究员负责证据整理",
...
function buildWorkflowPrompt(_domainId, request) {
  ...
  value = value.replace(/^让(?:账号发现与解析师|获客策略师|线索猎人|线索分析师|客户画像研究员|客户分析员|客户研究员|线索交接师|触达策略师|风控专员|线索归档师|外联专员|公开任务运营师|触达运营专员|内容策划|幕僚长)/, "").trim();
...
function decorateHomeHero({ activeShortcutId = SALES_SHORTCUTS[0].id, onShortcutSelect = null } = {}) {
  ...
  if (!hero.dataset.sbHeroDecorated) {
    ...
    const mark = el("img", "sb-home-hero-mark");
    mark.src = BYERING_LOGO_MARK_URL;
    mark.alt = "";
    const name = el("span", "sb-home-hero-name");
