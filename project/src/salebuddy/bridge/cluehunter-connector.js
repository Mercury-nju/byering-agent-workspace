...
function eventFromLegacy(source, context, { result = null, index = 0, namespace = "command", now = null } = {}) {
  ...
  const payload = withoutUndefined({
    ...
    secUid: pick(source, "consumerSecUid", "consumer_sec_uid", "secUid", "sec_uid", "targetSecUid", "target_sec_uid"),
    secId: pick(source, "consumerOpenId", "consumer_open_id", "secId", "sec_id", "targetSecId", "target_sec_id"),
    reqId: pick(source, "reqId", "req_id", "requestId", "request_id", "idempotencyKey", "idempotency_key"),
    commandId: pick(source, "commandId", "command_id", "letterInfoId", "letter_info_id"),
    ackId,
