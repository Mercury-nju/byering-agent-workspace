...
function readConfiguration(env = process.env) {
  ...
  return {
    mcpUrl: nonEmpty(source.BYERING_DOUYIN_DATA_MCP_URL)
      || nonEmpty(source.BYERING_DOUYIN_MCP_URL),
    ...
    timeoutMs: Number(source.BYERING_DOUYIN_DATA_MCP_TIMEOUT_MS || source.BYERING_PROSPECT_SPIDER_TIMEOUT_MS || 30000),
    paths: {
