...
export function remoteTaskIdentity(response) {
  ...
  return {
    ...
    state: data.state || data.taskState || data.task_state || null,
...
export async function createRemoteTask({ commandClient, taskText, projectId, projectName, localTaskId, scenario, chiefDecisionId } = {}) {
