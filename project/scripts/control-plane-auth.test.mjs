...
test("production refuses to start when tenant-scoped API keys are absent", () => {
  assert.throws(() => createControlPlaneHttpServer({
    auth: { production: true, apiKeys: {} }
  }), (error) => error?.code === "CONTROL_PLANE_PRODUCTION_AUTH_NOT_CONFIGURED");
});
