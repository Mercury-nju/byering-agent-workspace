...
test("internal customer research stays distinct from the marketplace customer analyst", () => {
  const researcher = getAgentManifest("prospect_researcher");
  assert.equal(researcher.displayName, "客户画像研究员");
  assert.notEqual(researcher.displayName, "客户分析员");
});
