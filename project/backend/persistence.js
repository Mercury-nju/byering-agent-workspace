...
export class PersistenceAdapter {
  ...
  listTasks() { throw new Error("PersistenceAdapter.listTasks is not implemented"); }
  ...
  replaceEvents() { throw new Error("PersistenceAdapter.replaceEvents is not implemented"); }
...
export class MemoryPersistenceAdapter extends PersistenceAdapter {
  ...
  replaceEvents(taskId, events) {
    this.events.set(taskId, Array.isArray(events) ? events.map(clone) : []);
  }
...
export class FilePersistenceAdapter extends MemoryPersistenceAdapter {
  ...
  replaceEvents(taskId, events) {
    super.replaceEvents(taskId, events);
    this.flush();
  }
