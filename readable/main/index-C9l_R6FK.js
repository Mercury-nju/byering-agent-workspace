...
function Un() {
  ...
  function k(c) {
    ...
    var t = {},
      a = typeof c,
      f;
    if (c.protocol === "blob:") t = new v(unescape(c.pathname), {});
    else if (a === "string") {
      t = new v(c, {});
      for (f in x) delete t[f];
    } else if (a === "object") {
      for (f in c) f in x || (t[f] = c[f]);
  ...
  function S(c, z) {
    ...
    return (
      a
        ? f
          ? ((o = l[2] + l[3] + l[4]), (w = l[2].length + l[3].length))
          : ((o = l[2] + l[4]), (w = l[2].length))
        : f
          ? ((o = l[3] + l[4]), (w = l[3].length))
          : (o = l[4]),
      t === "file:"
        ? w >= 2 && (o = o.slice(2))
        : q(t)
  ...
  function D(c, z) {
    if (c === "") return z;
    for (
      var l = (z || "/").split("/").slice(0, -1).concat(c.split("/")),
        t = l.length,
        a = l[t - 1],
        f = !1,
        w = 0;
  ...
  function v(c, z, l) {
    ...
    var t,
      ...
      T = 0;
    for (
      _ !== "object" && _ !== "string" && ((l = z), (z = null)),
        l && typeof l != "function" && (l = i.parse),
        z = k(z),
        a = S(c || "", z),
        t = !a.protocol && !a.slashes,
        r.slashes = a.slashes || (t && z.slashes),
        r.protocol = a.protocol || z.protocol || "",
        c = a.rest,
        ((a.protocol === "file:" && (a.slashesCount !== 2 || j.test(c))) ||
          (!a.slashes &&
            (a.protocol || a.slashesCount < 2 || !q(r.protocol)))) &&
          (m[3] = [/(.*)/, "pathname"]);
      T < m.length;
      T++
    ) {
      ...
      ((f = w[0]),
        ...
        f !== f
          ? (r[d] = c)
          : typeof f == "string"
            ? ((o = f === "@" ? c.lastIndexOf(f) : c.indexOf(f)),
              ~o &&
                (typeof w[2] == "number"
                  ? ((r[d] = c.slice(0, o)), (c = c.slice(o + w[2])))
                  : ((r[d] = c.slice(o)), (c = c.slice(0, o)))))
            : (o = f.exec(c)) && ((r[d] = o[1]), (c = c.slice(0, o.index))),
        (r[d] = r[d] || (t && w[3] && z[d]) || ""),
        w[4] && (r[d] = r[d].toLowerCase()));
    }
    (l && (r.query = l(r.query)),
      t &&
        z.slashes &&
        r.pathname.charAt(0) !== "/" &&
        (r.pathname !== "" || z.pathname !== "") &&
        (r.pathname = D(r.pathname, z.pathname)),
      r.pathname.charAt(0) !== "/" &&
        q(r.protocol) &&
        (r.pathname = "/" + r.pathname),
      n(r.port, r.protocol) || ((r.host = r.hostname), (r.port = "")),
      (r.username = r.password = ""),
      r.auth &&
        ((o = r.auth.indexOf(":")),
        ~o
          ? ((r.username = r.auth.slice(0, o)),
            (r.username = encodeURIComponent(decodeURIComponent(r.username))),
            (r.password = r.auth.slice(o + 1)),
            (r.password = encodeURIComponent(decodeURIComponent(r.password))))
          : (r.username = encodeURIComponent(decodeURIComponent(r.auth))),
        (r.auth = r.password ? r.username + ":" + r.password : r.username)),
      (r.origin =
        r.protocol !== "file:" && q(r.protocol) && r.host
          ? r.protocol + "//" + r.host
          : "null"),
      (r.href = r.toString()));
  }
  function W(c, z, l) {
    ...
    switch (c) {
      case "query":
        (typeof z == "string" && z.length && (z = (l || i.parse)(z)),
          (t[c] = z));
        break;
      case "port":
        ((t[c] = z),
          n(z, t.protocol)
            ? z && (t.host = t.hostname + ":" + z)
            : ((t.host = t.hostname), (t[c] = "")));
        break;
      case "hostname":
      ...
      case "auth":
        var f = z.indexOf(":");
        ~f
          ? ((t.username = z.slice(0, f)),
            (t.username = encodeURIComponent(decodeURIComponent(t.username))),
            (t.password = z.slice(f + 1)),
            (t.password = encodeURIComponent(decodeURIComponent(t.password))))
          : (t.username = encodeURIComponent(decodeURIComponent(z)));
    }
    ...
    return (
      (t.auth = t.password ? t.username + ":" + t.password : t.username),
      (t.origin =
        t.protocol !== "file:" && q(t.protocol) && t.host
          ? t.protocol + "//" + t.host
          : "null"),
      (t.href = t.toString()),
      t
  ...
  function E(c) {
    ...
    return (
      l.username
        ? ((f += l.username), l.password && (f += ":" + l.password), (f += "@"))
        : l.password
          ? ((f += ":" + l.password), (f += "@"))
          : l.protocol !== "file:" &&
            q(l.protocol) &&
            ...
            l.pathname !== "/" &&
            (f += "@"),
      (t[t.length - 1] === ":" || (s.test(l.hostname) && !l.port)) &&
        (t += ":"),
      (f += t + l.pathname),
      (z = typeof l.query == "object" ? c(l.query) : l.query),
      z && (f += z.charAt(0) !== "?" ? "?" + z : z),
      l.hash && (f += l.hash),
      f
    );
...
Un();
const on = "__MARVIS_CARD_API_CONTEXT__",
  kn = window[on] ?? (window[on] = In(null));
kn.Provider;
function $n() {
  const n = Nn(kn);
  if (!n) throw new Error("useCardApi must be used within a CardApiProvider");
  return n;
}
function On() {
  const n = $n(),
    [i, h] = R(() => n.location.getAuthState());
  A(() => {
    ...
    return (
      n.location.onAuthStateChange(s),
      () => {
  ...
  const g = J(async () => {
    ...
    u = J(async () => n.location.queryLocation(), [n]);
  return { authState: i, requestAuth: g, queryLocation: u };
}
const Bn =
    "data:image/svg+xml,%3csvg%20width='20'%20height='20'%20viewBox='0%200%2020%2020'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M9.29771%2018.3409C9.68573%2018.7296%2010.3155%2018.7299%2010.7039%2018.3415L14.6882%2014.3572C15.6152%2013.4308%2016.2467%2012.2502%2016.5027%2010.9648C16.7587%209.67945%2016.6277%208.34702%2016.1264%207.13608C15.625%205.92514%2014.7758%204.89009%2013.6861%204.16185C12.5964%203.43362%2011.3152%203.04492%2010.0046%203.04492C8.69399%203.04492%207.4128%203.43362%206.32312%204.16185C5.23343%204.89009%204.3842%205.92514%203.88285%207.13608C3.38149%208.34702%203.25053%209.67945%203.50654%2010.9648C3.76254%2012.2502%204.39401%2013.4308%205.32107%2014.3572L9.29771%2018.3409Z'%20stroke='%230080FF'%20stroke-width='1.10428'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3ccircle%20cx='10.0011'%20cy='9.34582'%20r='2.98157'%20stroke='%230080FF'%20stroke-width='1.10428'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3c/svg%3e",
  Fn = "_locationPermission_12zyc_1",
  Wn = "_icon_12zyc_7",
  Hn = "_permissionText_12zyc_14",
  K = {
  ...
  jh = ({ onClick: n, force: i = !0 }) => {
    const { requestAuth: h, authState: g, queryLocation: u } = On(),
      s = M(null);
    return (
      A(() => {
...
var Kn = /* @__PURE__ */ ((n) => (
  (n[(n.SELF_PICKUP = 1)] = "SELF_PICKUP"),
  (n[(n.DELIVERY = 2)] = "DELIVERY"),
  (n[(n.DINE_IN = 3)] = "DINE_IN"),
  (n[(n.SCHEDULED_PICKUP = 4)] = "SCHEDULED_PICKUP"),
  n
))(Kn || {});
const Vn = /^[\uD800-\uDBFF]$/,
  Qn = /^[\uDC00-\uDFFF]$/,
...
function I(n) {
  ...
  return (
    n.length -
    (((i = n.match(Yn)) === null || i === void 0 ? void 0 : i.length) || 0)
  );
}
function Q(n) {
  const i = [];
  ...
  for (; h < n.length;) {
    const g = n[h];
    Vn.test(g) && Qn.test(n[h + 1])
      ? (i.push(n.substring(h, h + 2)), (h += 2))
      : (i.push(g), (h += 1));
  }
  return i;
}
class _n {
  ...
  get(i) {
    if (i.length > 1) return this.StringDICT.get(i);
    {
  ...
  set(i, h) {
    if (i.length > 1) this.StringDICT.set(i, h);
    else {
...
function yi(n) {
  return n.priority === P.Custom
    ? -(n.length * n.length * 100)
    : n.priority === P.Surname
...
function ri(n, i) {
  ...
  for (let s = i - 1; s >= 0; s--) {
    const e =
      s + 1 >= i ? { probability: 1, decimal: 0, patterns: [] } : h[s + 1];
    ...
    (bn(j),
      (h[s] = xn(h[s], j)),
      h[s].concatPattern &&
        ((h[s].patterns = h[s].patterns.concat(h[s].concatPattern)),
        (h[s].concatPattern = void 0),
        delete h[s + 1]));
  }
...
function xi(n, i) {
  return !(
    i.index + i.length <= n.index ||
    i.priority > n.priority ||
    (i.priority === n.priority && i.length > n.length)
  );
}
function bi(n) {
  const i = [];
...
class fi {
  ...
  buildTrie(i) {
    for (let h of i) {
      ...
      (this.insertPattern(u.patterns, h),
        (h.node = u),
        this.addPatternToDictMap(h));
    }
  }
  // 构建失败指针
  buildFailPointer() {
    ...
    for (
      ...
      let g = i[h++],
        ...
        s = g.key;
      for (; u && !u.children.has(s);) u = u.fail;
      u ? (g.fail = u.children.get(s)) : (g.fail = this.root);
    }
  }
  // 将 pattern 添加到 dictMap 中
  addPatternToDictMap(i) {
    (this.dictMap.has(i.dict) ||
      this.dictMap.set(i.dict, /* @__PURE__ */ new Set()),
      this.dictMap.get(i.dict).add(i));
  }
  addNodeToQueues(i) {
    (this.queues[I(i.prefix)] || (this.queues[I(i.prefix)] = []),
      this.queues[I(i.prefix)].push(i));
  }
  // 按照优先级插入 pattern
  insertPattern(i, h) {
    for (let g = i.length - 1; g >= 0; g--) {
      ...
      if (h.priority === u.priority && h.probability >= u.probability)
        i[g + 1] = u;
      else if (h.priority > u.priority) i[g + 1] = u;
      else {
        i[g + 1] = h;
        return;
      }
  ...
  match(i, h) {
    ...
    for (let e = 0; e < s.length; e++) {
      let j = s[e];
      for (; g !== null && !g.children.has(j);) g = g.fail;
      if (g === null) g = this.root;
      else {
        g = g.children.get(j);
        const b = g.patterns.find((x) =>
          h === "off"
            ? x.priority !== P.Surname
            : h === "head"
              ? x.length - 1 - e === 0
              : !0,
        );
        b &&
          u.push(
            Object.assign(Object.assign({}, b), { index: e - b.length + 1 }),
          );
        let y = g.fail;
        for (; y !== null;) {
          const x = y.patterns.find((k) =>
            h === "off"
              ? k.priority !== P.Surname
              : h === "head"
                ? k.length - 1 - e === 0
                : !0,
          );
          (x &&
            u.push(
              Object.assign(Object.assign({}, x), { index: e - x.length + 1 }),
            ),
            (y = y.fail));
        }
      }
...
const Z = (n) => {
    ...
    for (let s of h)
      for (let e of Xn)
        if (s.startsWith(e)) {
          ...
          (Jn.indexOf(e) !== -1 && ni.indexOf(j) !== -1 && (j = ii[j]),
            g.push(e),
            u.push(j));
          break;
        }
  ...
  $ = (n) => {
    ...
    return (
      hi.indexOf(B(i)) !== -1
        ? ((h = i[0]), (g = i[1]), (u = i.slice(2)))
        : ((g = i[0] || ""), (u = i.slice(1) || "")),
      { head: h, body: g, tail: u }
    );
  },
  F = (n) => {
...
function vi(n, i, h) {
  if (oi.indexOf(n) === -1) return Z(n);
  if (i === h && i && Z(i) !== i) return B(Z(n));
  if (h && !si[n].includes(h)) {
    const g = Z(h);
    if (g !== h) {
      const u = F(g),
        s = Cn[n];
      for (let e in s) if (s[e].indexOf(Number(u)) !== -1) return e;
    }
  }
}
function Pi(n, i) {
  if (n === "了" && (!i || !L.get(i))) return "liǎo";
}
function Ii(n, i) {
  if (n === "々") return !i || !L.get(i) ? "tóng" : L.get(i).split(" ")[0];
}
function wn(n, i, h) {
...
const Di = (n, i) => {
    ...
    if (h === "consecutive") {
      for (let g = n.length - 2; g >= 0; g--) {
        ...
        !u.isZh &&
          !s.isZh &&
          V(u.origin, i.nonZhScope) &&
          V(s.origin, i.nonZhScope) &&
          ((u.origin += s.origin), (u.result += s.result), (s.delete = !0));
      }
      return n.filter((g) => !g.delete);
    } else return n;
  },
  pn = (n, i) => (I(n) === 1 && i.multiple ? Ci(n, i.surname) : !1),
  Li = (n, i) => {
    switch (i.pattern) {
      case "pinyin":
        break;
      ...
      : i.type === "all"
        ? n.map((g) => {
            const u = g.isZh ? g.result : "",
              { initial: s, final: e } = O(u, i.initialPattern),
              { head: j, body: b, tail: y } = $(u);
            let x = [];
            return (
              u !== "" &&
                (x = [u].concat(
                  vn(g.origin, i.surname).filter((k) => k !== u),
                )),
              {
                origin: g.origin,
                pinyin: u,
  ...
  Mi = (n, i) => (
    i === !1 &&
      n.forEach((h) => {
        h.origin === "一"
          ? (h.result = h.originPinyin = "yī")
          : h.origin === "不" && (h.result = h.originPinyin = "bù");
      }),
    n
  ),
  Ri = {
...
function Zi(n, i) {
  if (((i = Object.assign(Object.assign({}, Ri), i || {})), !Ni(n))) return n;
  if (n === "") return i.type === "array" || i.type === "all" ? [] : "";
  (i.surname === void 0 &&
    (i.mode === "surname" ? (i.surname = "all") : (i.surname = "off")),
    i.type === "all" && (i.pattern = "pinyin"),
    i.pattern === "num" && (i.toneType = "none"),
    i.removeNonZh && (i.nonZh = "removed"));
  let g = Array(I(n)),
    { list: u } = _i(n, g, i.surname, i.segmentit, i.traditional);
  return (
    (u = Mi(u, i.toneSandhi)),
    (u = Di(u, i)),
    pn(n, i) && (u = pn(n, i)),
...
var X;
(function (n) {
  ((n[(n.AllSegment = 1)] = "AllSegment"),
    (n[(n.AllArray = 2)] = "AllArray"),
    (n[(n.AllString = 3)] = "AllString"),
    (n[(n.PinyinSegment = 4)] = "PinyinSegment"),
    (n[(n.PinyinArray = 5)] = "PinyinArray"),
    (n[(n.PinyinString = 6)] = "PinyinString"),
    (n[(n.ZhSegment = 7)] = "ZhSegment"),
    (n[(n.ZhArray = 8)] = "ZhArray"),
    (n[(n.ZhString = 9)] = "ZhString"));
})(X || (X = {}));
X.AllSegment;
const Ui =
    "data:image/svg+xml,%3csvg%20width='20'%20height='20'%20viewBox='0%200%2020%2020'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M4.18359%2010.8864L7.93085%2014.6336C8.26642%2014.9692%208.81437%2014.9562%209.13359%2014.605L15.82%207.25'%20stroke='black'%20stroke-width='1.5'%20stroke-linecap='round'/%3e%3c/svg%3e",
  $i = "_modalContent_149um_2",
  Oi = "_modalHeader_149um_32",
  Bi = "_title_149um_37",
  Fi = "_cityMode_149um_44",
  Wi = "_citySelectArea_149um_54",
  Hi = "_cityMain_149um_69",
  Gi = "_header_149um_76",
  Ki = "_text_149um_80",
  Vi = "_label_149um_87",
  Qi = "_value_149um_91",
  Yi = "_cityBody_149um_99",
  Xi = "_cityScroll_149um_96",
  Ji = "_cityGroupItem_149um_118",
  nh = "_groupName_149um_118",
  ih = "_cityList_149um_127",
  hh = "_cityItem_149um_133",
  gh = "_active_149um_138",
  uh = "_activeIcon_149um_155",
  sh = "_cityLetter_149um_161",
  oh = "_letter_149um_180",
  th = "_footer_149um_203",
  ch = "_action_149um_212",
  lh = "_btnCancel_149um_216",
  zh = "_btnPrimary_149um_248",
  p = {
    modalContent: $i,
    modalHeader: Oi,
    title: Bi,
  ...
  xh = ({
    ...
    const [e, j] = R([]),
      b = nn(() => {
        ...
        return (
          ...
          e.forEach((d) => {
            const m = (d.city_spell || d.__pinyin__).slice(0, 1).toUpperCase(),
              _ = o.get(m) || [];
            (_.push(d), o.set(m, _));
          }),
          o
      ...
      k = (o, d) => {
        ...
        if (typeof o == "string") {
          const m = o;
          return (
            d.find((_) => _.show_name === m || _.name === m) ??
            d.find(
              (_) =>
                _.show_name.replace("市", "") === m ||
                _.name.replace("市", "") === m,
            ) ??
            d.find(
              (_) =>
                m.startsWith(_.show_name.replace("市", "")) ||
                m.startsWith(_.name.replace("市", "")),
            ) ??
            null
          );
        }
        return (
          d.find(
            (m) => m.show_name === o.show_name || m.show_name === o.name,
          ) ??
          d.find((m) => m.name === o.name || m.name === o.show_name) ??
          null
        );
      },
      [q, S] = R(""),
      D = nn(() => (y ? y.show_name.replace("市", "") : ""), [y]),
      [v, W] = R(!1),
      E = M(0),
      c = M(null),
      z = (o) => {
    ...
    return (
      ...
      A(() => {
        ...
        const o = c.current;
        return (
          o.addEventListener("scroll", w.run),
          w.run(),
          () => {
      ...
      A(() => {
        ...
        if (m <= 0) return;
        const r = d.offsetTop - o.offsetTop - 20,
          T = Math.max(0, Math.min(m, r));
      ...
      A(() => {
        ...
        return (
          o.addEventListener("wheel", d, { passive: !0 }),
          o.addEventListener("touchstart", d, { passive: !0 }),
          () => {
            (o.removeEventListener("wheel", d),
      ...
      A(() => {
        En.getCityList({ brand: g }).then((o) => {
          ...
          } else eh.warn("[getCityList] getCityList is empty");
        });
      }, [g]),
      /* @__PURE__ */ C(Mn, {
        ...
        children: /* @__PURE__ */ N(Ln, {
          children: [
            ...
            /* @__PURE__ */ N("div", {
              className: `${p.cityMode}`,
              children: [
                /* @__PURE__ */ N("div", {
                  className: p.citySelectArea,
                  children: [
                    /* @__PURE__ */ N("div", {
                      className: p.cityMain,
                      children: [
                        /* @__PURE__ */ N("div", {
                          className: p.header,
                          children: [
                            /* @__PURE__ */ C("span", {
                              className: `${p.text} ${p.label}`,
                              children: "当前选择城市",
                            }),
                            /* @__PURE__ */ C("span", {
                              className: `${p.text} ${p.value}`,
                              children: D,
                            }),
                          ],
                        }),
                        /* @__PURE__ */ C("div", {
                          className: p.cityBody,
                          children: /* @__PURE__ */ C("div", {
                            className: p.cityScroll,
                            ref: z,
                            children: Array.from(b.keys()).map((o) =>
                              /* @__PURE__ */ N(
                                "div",
                                {
                                  className: p.cityGroupItem,
                                  id: `group-${o}`,
                                  children: [
                                    /* @__PURE__ */ C("span", {
                                    ...
                                    (b.get(o) || []).length > 0 &&
                                      /* @__PURE__ */ C("div", {
                                        className: p.cityList,
                                        children: (b.get(o) || []).map((d) =>
                                          /* @__PURE__ */ N(
                                            "div",
                                            {
...
export { xh as C, Kn as F, jh as L, dh as s, On as u };
