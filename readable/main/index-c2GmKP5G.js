...
if (!Be)
  throw new Error(
    "[marvis-card] window.__MARVIS_REACT_DOM_CLIENT__ 未注入；请确认主端已调用 installMarvisCardHostRuntime() 暴露 React 实例",
  );
const { createRoot: Me, hydrateRoot: Qt, version: er } = Be,
  Ae = window.__MARVIS_REACT_DOM__;
if (!Ae)
  throw new Error(
    "[marvis-card] window.__MARVIS_REACT_DOM__ 未注入；请确认主端已调用 installMarvisCardHostRuntime() 暴露 React 实例",
  );
const {
    createPortal: lt,
    flushSync: tr,
  ...
  ut = 10,
  dt = 0.2,
  Pe = "ai_launcher_overlay_contain";
function ve(t) {
        ...
        (function () {
          ...
          function o(a) {
            ...
            if (
              ...
              return a.toString();
            var i = "";
            for (var s in a) e.call(a, s) && a[s] && (i = n(i, s));
            return i;
          }
          function n(a, i) {
...
var bt = mt();
const R = /* @__PURE__ */ ft(bt),
  _t = "_overlay_10ij9_6",
  vt = "_modal_10ij9_18",
  pt = "_modalBasic_10ij9_30",
  ht = "_title_10ij9_37",
  gt = "_content_10ij9_42",
  yt = "_btn_10ij9_46",
  wt = "_footer_10ij9_80",
  jt = "_footerButtons_10ij9_81",
  St = "_closeBtn_10ij9_86",
  Tt = "_titleIcon_10ij9_123",
  Ct = "_titleText_10ij9_137",
  Ot = "_footerExtra_10ij9_159",
  It = "_btnDefault_10ij9_190",
  xt = "_btnPrimary_10ij9_198",
  u = {
    overlay: _t,
    modal: vt,
    modalBasic: pt,
  ...
  de(() => {
    if (t) {
      ...
      return (
        He(d),
        (A += 1),
        S.push({ id: x, zIndex: d }),
        (document.body.style.overflow = "hidden"),
        () => {
          ((A -= 1),
            A <= 0 && ((A = 0), (document.body.style.overflow = "")),
            A === 0 && (fe = 0));
  ...
  const Xe = M(
    ...
    Qe = () =>
      j === null || !P
        ? null
        : j !== void 0
          ? /* @__PURE__ */ f("div", { className: u.footer, children: j })
          : C && C.length > 0
            ? /* @__PURE__ */ f("div", { className: u.footer, children: Je(C) })
            : !y || !_
              ? /* @__PURE__ */ k("div", {
                  className: u.footer,
                  children: [
    ...
    et = () => {
      ...
      return /* @__PURE__ */ k("div", {
        ...
        children: [
          d &&
            /* @__PURE__ */ f("span", { className: u.titleIcon, children: d }),
...
function Bt(t, e, r) {
  if (r || arguments.length === 2)
    for (var o = 0, n = e.length, a; o < n; o++)
      (a || !(o in e)) &&
        (a || (a = Array.prototype.slice.call(e, 0, o)), (a[o] = e[o]));
  ...
  function i(s, m, c) {
    ...
    ((m = r(m) || 0),
      t(c) &&
        ((P = !!c.leading),
        (j = "maxWait" in c),
        (w = j ? n(r(c.maxWait) || 0, m) : w),
        (C = "trailing" in c ? !!c.trailing : C)));
    function E(l) {
      var p = b,
        I = v;
    ...
    function B() {
      ...
      if (((b = arguments), (v = this), (y = l), p)) {
        if (_ === void 0) return z(y);
        if (j) return (clearTimeout(_), (_ = setTimeout(O, m)), E(y));
      }
...
function Kt() {
  var t =
      (typeof global > "u" ? "undefined" : typeof global) == "object" &&
      global &&
...
function mr(t, e) {
  var r,
    o = Fe(t),
    n = (r = e?.wait) !== null && r !== void 0 ? r : 1e3,
    a = it(function () {
      return Zt(
        function () {
...
export { be as A, Lt as _, H as c, Jt as s, mr as u };
