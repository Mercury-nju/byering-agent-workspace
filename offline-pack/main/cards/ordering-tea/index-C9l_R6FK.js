import { s as In, t as Nn, b as R, d as A, e as J, m as M, f as N, j as C, c as nn, o as Dn, F as Ln, h as Tn } from "./report-BkiHygWt.js";
import { c as hn, u as An, s as En, A as Mn } from "./index-c2GmKP5G.js";
const dh = "data:image/svg+xml,%3csvg%20width='16'%20height='16'%20viewBox='0%200%2016%2016'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20clip-path='url(%23clip0_864_31822)'%3e%3cpath%20d='M6.90346%2012.4759C9.98048%2012.4759%2012.4749%209.98145%2012.4749%206.90444C12.4749%203.82742%209.98048%201.33301%206.90346%201.33301C3.82645%201.33301%201.33203%203.82742%201.33203%206.90444C1.33203%209.98145%203.82645%2012.4759%206.90346%2012.4759Z'%20stroke='black'%20stroke-opacity='0.5'%20stroke-width='0.888889'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3cpath%20d='M11.082%2011.083L14.332%2014.333'%20stroke='black'%20stroke-opacity='0.5'%20stroke-width='0.888889'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3c/g%3e%3cdefs%3e%3cclipPath%20id='clip0_864_31822'%3e%3crect%20width='16'%20height='16'%20fill='white'/%3e%3c/clipPath%3e%3c/defs%3e%3c/svg%3e";
var H, gn;
function Rn() {
  return gn || (gn = 1, H = function(i, h) {
    if (h = h.split(":")[0], i = +i, !i) return !1;
    switch (h) {
      case "http":
      case "ws":
        return i !== 80;
...
function Zn() {
  ...
  function u(e) {
    for (var j = /([^=?#&]+)=?([^&]*)/g, b = {}, y; y = j.exec(e); ) {
      var x = h(y[1]), k = h(y[2]);
      x === null || k === null || x in b || (b[x] = k);
    }
    return b;
  }
  function s(e, j) {
    ...
    for (x in e)
      if (n.call(e, x)) {
        if (y = e[x], !y && (y === null || y === i || isNaN(y)) && (y = ""), x = g(x), y = g(y), x === null || y === null) continue;
        b.push(x + "=" + y);
      }
    return b.length ? j + b.join("&") : "";
  }
  return U.stringify = s, U.parse = u, U;
}
var G, sn;
function Un() {
  if (sn) return G;
  sn = 1;
  var n = Rn(), i = Zn(), h = /^[\x00-\x20\u00a0\u1680\u2000-\u200a\u2028\u2029\u202f\u205f\u3000\ufeff]+/, g = /[\n\r\t]/g, u = /^[A-Za-z][A-Za-z0-9+-.]*:\/\//, s = /:\d+$/, e = /^([a-z][a-z0-9.+-]*:)?(\/\/)?([\\/]+)?([\S\s]*)/i, j = /^[a-zA-Z]:/;
  function b(c) {
    return (c || "").toString().replace(h, "");
  }
  var y = [
    ["#", "hash"],
    ...
    // Extract from the back.
    function(z, l) {
      return q(l.protocol) ? z.replace(/\\/g, "/") : z;
    },
    ["/", "pathname"],
    // Extract from the back.
    ["@", "auth", 1],
  ...
  function k(c) {
    var z;
    typeof window < "u" ? z = window : typeof hn < "u" ? z = hn : typeof self < "u" ? z = self : z = {};
    var l = z.location || {};
    c = c || l;
    var t = {}, a = typeof c, f;
    if (c.protocol === "blob:")
      t = new v(unescape(c.pathname), {});
    else if (a === "string") {
      t = new v(c, {});
      for (f in x) delete t[f];
    } else if (a === "object") {
      for (f in c)
        f in x || (t[f] = c[f]);
      t.slashes === void 0 && (t.slashes = u.test(c.href));
    }
    return t;
  }
  function q(c) {
  ...
  function S(c, z) {
    c = b(c), c = c.replace(g, ""), z = z || {};
    var l = e.exec(c), t = l[1] ? l[1].toLowerCase() : "", a = !!l[2], f = !!l[3], w = 0, o;
    return a ? f ? (o = l[2] + l[3] + l[4], w = l[2].length + l[3].length) : (o = l[2] + l[4], w = l[2].length) : f ? (o = l[3] + l[4], w = l[3].length) : o = l[4], t === "file:" ? w >= 2 && (o = o.slice(2)) : q(t) ? o = l[4] : t ? a && (o = o.slice(2)) : w >= 2 && q(z.protocol) && (o = l[4]), {
      protocol: t,
      slashes: a || q(t),
      slashesCount: w,
      rest: o
  ...
  function D(c, z) {
    if (c === "") return z;
    for (var l = (z || "/").split("/").slice(0, -1).concat(c.split("/")), t = l.length, a = l[t - 1], f = !1, w = 0; t--; )
      l[t] === "." ? l.splice(t, 1) : l[t] === ".." ? (l.splice(t, 1), w++) : w && (t === 0 && (f = !0), l.splice(t, 1), w--);
    return f && l.unshift(""), (a === "." || a === "..") && l.push(""), l.join("/");
  }
  function v(c, z, l) {
    if (c = b(c), c = c.replace(g, ""), !(this instanceof v))
      return new v(c, z, l);
    var t, a, f, w, o, d, m = y.slice(), _ = typeof z, r = this, T = 0;
    for (_ !== "object" && _ !== "string" && (l = z, z = null), l && typeof l != "function" && (l = i.parse), z = k(z), a = S(c || "", z), t = !a.protocol && !a.slashes, r.slashes = a.slashes || t && z.slashes, r.protocol = a.protocol || z.protocol || "", c = a.rest, (a.protocol === "file:" && (a.slashesCount !== 2 || j.test(c)) || !a.slashes && (a.protocol || a.slashesCount < 2 || !q(r.protocol))) && (m[3] = [/(.*)/, "pathname"]); T < m.length; T++) {
      if (w = m[T], typeof w == "function") {
        c = w(c, r);
        continue;
      }
      f = w[0], d = w[1], f !== f ? r[d] = c : typeof f == "string" ? (o = f === "@" ? c.lastIndexOf(f) : c.indexOf(f), ~o && (typeof w[2] == "number" ? (r[d] = c.slice(0, o), c = c.slice(o + w[2])) : (r[d] = c.slice(o), c = c.slice(0, o)))) : (o = f.exec(c)) && (r[d] = o[1], c = c.slice(0, o.index)), r[d] = r[d] || t && w[3] && z[d] || "", w[4] && (r[d] = r[d].toLowerCase());
    }
    l && (r.query = l(r.query)), t && z.slashes && r.pathname.charAt(0) !== "/" && (r.pathname !== "" || z.pathname !== "") && (r.pathname = D(r.pathname, z.pathname)), r.pathname.charAt(0) !== "/" && q(r.protocol) && (r.pathname = "/" + r.pathname), n(r.port, r.protocol) || (r.host = r.hostname, r.port = ""), r.username = r.password = "", r.auth && (o = r.auth.indexOf(":"), ~o ? (r.username = r.auth.slice(0, o), r.username = encodeURIComponent(decodeURIComponent(r.username)), r.password = r.auth.slice(o + 1), r.password = encodeURIComponent(decodeURIComponent(r.password))) : r.username = encodeURIComponent(decodeURIComponent(r.auth)), r.auth = r.password ? r.username + ":" + r.password : r.username), r.origin = r.protocol !== "file:" && q(r.protocol) && r.host ? r.protocol + "//" + r.host : "null", r.href = r.toString();
  }
  function W(c, z, l) {
    var t = this;
    switch (c) {
      case "query":
        typeof z == "string" && z.length && (z = (l || i.parse)(z)), t[c] = z;
        break;
      case "port":
        t[c] = z, n(z, t.protocol) ? z && (t.host = t.hostname + ":" + z) : (t.host = t.hostname, t[c] = "");
        break;
      case "hostname":
        t[c] = z, t.port && (z += ":" + t.port), t.host = z;
        break;
      case "host":
        t[c] = z, s.test(z) ? (z = z.split(":"), t.port = z.pop(), t.hostname = z.join(":")) : (t.hostname = z, t.port = "");
        break;
      case "protocol":
        t.protocol = z.toLowerCase(), t.slashes = !l;
        break;
      case "pathname":
      case "hash":
        if (z) {
          var a = c === "pathname" ? "/" : "#";
          t[c] = z.charAt(0) !== a ? a + z : z;
        } else
          t[c] = z;
        break;
      case "username":
      case "password":
        t[c] = encodeURIComponent(z);
        break;
      case "auth":
        var f = z.indexOf(":");
        ~f ? (t.username = z.slice(0, f), t.username = encodeURIComponent(decodeURIComponent(t.username)), t.password = z.slice(f + 1), t.password = encodeURIComponent(decodeURIComponent(t.password))) : t.username = encodeURIComponent(decodeURIComponent(z));
    }
    for (var w = 0; w < y.length; w++) {
      var o = y[w];
      o[4] && (t[o[1]] = t[o[1]].toLowerCase());
    }
    return t.auth = t.password ? t.username + ":" + t.password : t.username, t.origin = t.protocol !== "file:" && q(t.protocol) && t.host ? t.protocol + "//" + t.host : "null", t.href = t.toString(), t;
  }
  function E(c) {
    (!c || typeof c != "function") && (c = i.stringify);
    var z, l = this, t = l.host, a = l.protocol;
    a && a.charAt(a.length - 1) !== ":" && (a += ":");
    var f = a + (l.protocol && l.slashes || q(l.protocol) ? "//" : "");
    return l.username ? (f += l.username, l.password && (f += ":" + l.password), f += "@") : l.password ? (f += ":" + l.password, f += "@") : l.protocol !== "file:" && q(l.protocol) && !t && l.pathname !== "/" && (f += "@"), (t[t.length - 1] === ":" || s.test(l.hostname) && !l.port) && (t += ":"), f += t + l.pathname, z = typeof l.query == "object" ? c(l.query) : l.query, z && (f += z.charAt(0) !== "?" ? "?" + z : z), l.hash && (f += l.hash), f;
  }
  return v.prototype = { set: W, toString: E }, v.extractProtocol = S, v.location = k, v.trimLeft = b, v.qs = i, G = v, G;
}
Un();
const on = "__MARVIS_CARD_API_CONTEXT__", kn = window[on] ?? (window[on] = In(null));
kn.Provider;
function $n() {
  const n = Nn(kn);
  if (!n)
    throw new Error("useCardApi must be used within a CardApiProvider");
  return n;
}
function On() {
  const n = $n(), [i, h] = R(() => n.location.getAuthState());
  A(() => {
    h(n.location.getAuthState());
    const s = (e) => {
      h(e);
    };
    return n.location.onAuthStateChange(s), () => {
      n.location.offAuthStateChange(s);
    };
  }, [n]);
  const g = J(async () => {
    await n.location.requestAuth();
  }, [n]), u = J(async () => n.location.queryLocation(), [n]);
  return { authState: i, requestAuth: g, queryLocation: u };
}
const Bn = "data:image/svg+xml,%3csvg%20width='20'%20height='20'%20viewBox='0%200%2020%2020'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M9.29771%2018.3409C9.68573%2018.7296%2010.3155%2018.7299%2010.7039%2018.3415L14.6882%2014.3572C15.6152%2013.4308%2016.2467%2012.2502%2016.5027%2010.9648C16.7587%209.67945%2016.6277%208.34702%2016.1264%207.13608C15.625%205.92514%2014.7758%204.89009%2013.6861%204.16185C12.5964%203.43362%2011.3152%203.04492%2010.0046%203.04492C8.69399%203.04492%207.4128%203.43362%206.32312%204.16185C5.23343%204.89009%204.3842%205.92514%203.88285%207.13608C3.38149%208.34702%203.25053%209.67945%203.50654%2010.9648C3.76254%2012.2502%204.39401%2013.4308%205.32107%2014.3572L9.29771%2018.3409Z'%20stroke='%230080FF'%20stroke-width='1.10428'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3ccircle%20cx='10.0011'%20cy='9.34582'%20r='2.98157'%20stroke='%230080FF'%20stroke-width='1.10428'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3c/svg%3e", Fn = "_locationPermission_12zyc_1", Wn = "_icon_12zyc_7", Hn = "_permissionText_12zyc_14", K = {
  locationPermission: Fn,
  icon: Wn,
  permissionText: Hn
}, jh = ({ onClick: n, force: i = !0 }) => {
  const { requestAuth: h, authState: g, queryLocation: u } = On(), s = M(null);
  return A(() => {
    if (g?.authorized && s.current) {
      const e = u();
      s.current?.(e);
    }
  }, [g?.authorized, u]), g?.authorized && !i ? null : /* @__PURE__ */ N(
    "div",
    {
      className: K.locationPermission,
      onClick: async () => {
        if (await h(), g?.authorized) {
          const e = u();
          n?.(e);
          return;
        }
      ...
      children: [
        /* @__PURE__ */ C("img", { className: K.icon, src: Bn, alt: "" }),
        /* @__PURE__ */ C("span", { className: K.permissionText, children: "授权开启定位" })
      ]
    }
  );
}, Gn = [
...
var Kn = /* @__PURE__ */ ((n) => (n[n.SELF_PICKUP = 1] = "SELF_PICKUP", n[n.DELIVERY = 2] = "DELIVERY", n[n.DINE_IN = 3] = "DINE_IN", n[n.SCHEDULED_PICKUP = 4] = "SCHEDULED_PICKUP", n))(Kn || {});
const Vn = /^[\uD800-\uDBFF]$/, Qn = /^[\uDC00-\uDFFF]$/, Yn = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g;
var tn;
(function(n) {
...
function I(n) {
  var i;
  return n.length - (((i = n.match(Yn)) === null || i === void 0 ? void 0 : i.length) || 0);
}
function Q(n) {
  const i = [];
  let h = 0;
  for (; h < n.length; ) {
    const g = n[h];
    Vn.test(g) && Qn.test(n[h + 1]) ? (i.push(n.substring(h, h + 2)), h += 2) : (i.push(g), h += 1);
  }
  return i;
}
class _n {
  ...
  get(i) {
      ...
      return this.StringDICT.get(i);
    {
      ...
      return this.NumberDICT[h];
    }
  }
  set(i, h) {
    if (i.length > 1)
      this.StringDICT.set(i, h);
    else {
...
function gi() {
  ...
  for (let i in cn)
    for (let h in ln) {
      const g = `${i}${h}`, u = `${cn[i]} ${ln[h]}`;
      n[g] = u;
    }
  return n;
}
const zn = gi(), ui = Object.keys(zn).map((n) => ({
  zh: n,
  pinyin: zn[n],
  probability: 1e-12,
  length: I(n),
...
function yi(n) {
  return n.priority === P.Custom ? -(n.length * n.length * 100) : n.priority === P.Surname ? -(n.length * n.length * 10) : 0;
}
function ri(n, i) {
  const h = [];
  let g = n.length - 1, u = n[g];
  for (let s = i - 1; s >= 0; s--) {
    const e = s + 1 >= i ? { probability: 1, decimal: 0, patterns: [] } : h[s + 1];
    for (; u && u.index + u.length - 1 === s; ) {
      const b = u.index, y = {
        probability: u.probability * e.probability,
        decimal: e.decimal + yi(u),
        patterns: e.patterns,
        concatPattern: u
      };
      bn(y), h[b] = xn(h[b], y), u = n[--g];
    }
    const j = {
      probability: 1e-13 * e.probability,
      decimal: 0,
      patterns: e.patterns
    };
    bn(j), h[s] = xn(h[s], j), h[s].concatPattern && (h[s].patterns = h[s].patterns.concat(h[s].concatPattern), h[s].concatPattern = void 0, delete h[s + 1]);
  }
...
function di(n) {
  return n.priority === P.Custom ? -(n.length * n.length * 1e5) : n.priority === P.Surname ? -(n.length * n.length * 100) : 1;
}
function ji(n, i) {
  const h = [];
  let g = n.length - 1, u = n[g];
  for (let s = i - 1; s >= 0; s--) {
    const e = s + 1 >= i ? { count: 0, patterns: [] } : h[s + 1];
    for (; u && u.index + u.length - 1 === s; ) {
      const b = u.index, y = {
        count: di(u) + e.count,
        patterns: e.patterns,
    ...
    h[s] = fn(h[s], j), h[s].concatPattern && (h[s].patterns = h[s].patterns.concat(h[s].concatPattern), h[s].concatPattern = void 0, delete h[s + 1]);
  }
  return h[0].patterns.reverse();
}
function xi(n, i) {
...
function bi(n) {
  const i = [];
  for (let h = n.length - 1; h >= 0; ) {
    const { index: g } = n[h];
    let u = h - 1;
    for (; u >= 0 && xi(n[h], n[u]); )
      u--;
    (u < 0 || n[u].index + n[u].length <= g) && i.push(n[h]), h = u;
  }
  return i.reverse();
}
var mn;
...
class an {
  constructor(i, h = "", g = "") {
    this.children = /* @__PURE__ */ new Map(), this.fail = null, this.patterns = [], this.parent = i, this.prefix = h, this.key = g;
  }
}
class fi {
  constructor() {
    this.dictMap = /* @__PURE__ */ new Map(), this.queues = [], this.root = new an(null);
  }
  build(i) {
  ...
  buildTrie(i) {
    for (let h of i) {
      ...
      for (let s = 0; s < g.length; s++) {
        let e = g[s];
        if (!u.children.has(e)) {
          const j = new an(u, g.slice(0, s).join(""), e);
          u.children.set(e, j), this.addNodeToQueues(j);
        }
        u = u.children.get(e);
      }
      this.insertPattern(u.patterns, h), h.node = u, this.addPatternToDictMap(h);
    }
  }
  // 构建失败指针
  buildFailPointer() {
    let i = [], h = 0;
    for (this.queues.forEach((g) => {
      i = i.concat(g);
    }), this.queues = []; i.length > h; ) {
      let g = i[h++], u = g.parent && g.parent.fail, s = g.key;
      for (; u && !u.children.has(s); )
        u = u.fail;
      u ? g.fail = u.children.get(s) : g.fail = this.root;
    }
  }
  ...
  addNodeToQueues(i) {
    this.queues[I(i.prefix)] || (this.queues[I(i.prefix)] = []), this.queues[I(i.prefix)].push(i);
  }
  // 按照优先级插入 pattern
  insertPattern(i, h) {
    for (let g = i.length - 1; g >= 0; g--) {
      const u = i[g];
      if (h.priority === u.priority && h.probability >= u.probability)
        i[g + 1] = u;
      else if (h.priority > u.priority)
        i[g + 1] = u;
      else {
        i[g + 1] = h;
        return;
  ...
  removeDict(i) {
    this.dictMap.has(i) && (this.dictMap.get(i).forEach((g) => {
  ...
  match(i, h) {
    ...
    for (let e = 0; e < s.length; e++) {
      let j = s[e];
      for (; g !== null && !g.children.has(j); )
        g = g.fail;
      if (g === null)
        g = this.root;
      else {
        g = g.children.get(j);
        const b = g.patterns.find((x) => h === "off" ? x.priority !== P.Surname : h === "head" ? x.length - 1 - e === 0 : !0);
        b && u.push(Object.assign(Object.assign({}, b), { index: e - b.length + 1 }));
        let y = g.fail;
        for (; y !== null; ) {
          const x = y.patterns.find((k) => h === "off" ? k.priority !== P.Surname : h === "head" ? k.length - 1 - e === 0 : !0);
          x && u.push(Object.assign(Object.assign({}, x), { index: e - x.length + 1 })), y = y.fail;
        }
      }
    }
    return u;
  ...
  search(i, h, g = 2) {
    const u = this.match(i, h);
    return g === 1 ? bi(u) : g === 3 ? ji(u, I(i)) : ri(u, I(i));
  }
}
const mi = [
  ...ei,
...
const Z = (n) => {
  ...
  for (let g = 0; g < n.length; g++) {
    const u = n[g], s = u.charCodeAt(0);
    h[s] ? i[g] = h[s] : i[g] = u;
  }
  return i.join("");
}, _i = (n, i, h, g, u) => {
  const s = u ? ki(n) : n, e = Sn.search(s, h, g);
  let j = 0;
  const b = Q(n);
  for (let y = 0; y < b.length; ) {
    const x = e[j];
    if (x && y === x.index) {
      if (x.length === 1 && x.priority <= P.Normal) {
        const S = b[y];
        x.zh = S;
        let D = "";
        D = wn(S, b[y - 1], b[y + 1]), i[y] = {
          origin: S,
          result: D,
          isZh: D !== S,
          originPinyin: D
      ...
      const k = x.pinyin.split(" ");
      let q = 0;
      u && (x.zh = b.slice(x.index, x.index + x.length).join(""));
  ...
  return { list: i, matches: e };
}, B = (n) => n.replace(/(ā|á|ǎ|à)/g, "a").replace(/(ō|ó|ǒ|ò)/g, "o").replace(/(ē|é|ě|è)/g, "e").replace(/(ī|í|ǐ|ì)/g, "i").replace(/(ū|ú|ǔ|ù)/g, "u").replace(/(ǖ|ǘ|ǚ|ǜ)/g, "ü").replace(/(n̄|ń|ň|ǹ)/g, "n").replace(/(m̄|ḿ|m̌|m̀)/g, "m").replace(/(ê̄|ế|ê̌|ề)/g, "ê"), vn = (n, i = "off") => {
  const h = wi();
  let g = L.get(n) ? L.get(n).split(" ") : [];
  if (h.get(n))
    g = h.get(n).split(" ");
  else if (i !== "off") {
    const u = Y[n];
    u && (g = [u].concat(g.filter((s) => s !== u)));
  }
  return g;
}, Ci = (n, i = "off") => {
  let h = vn(n, i);
  return h.length > 0 ? h.map((g) => ({
    origin: n,
    result: g,
    isZh: !0,
    originPinyin: g
  ...
  for (let s of h)
    for (let e of Xn)
      if (s.startsWith(e)) {
        let j = s.slice(e.length);
        Jn.indexOf(e) !== -1 && ni.indexOf(j) !== -1 && (j = ii[j]), g.push(e), u.push(j);
        break;
      }
  return i === "standard" && g.forEach((s, e) => {
    (s === "y" || s === "w") && (g[e] = "");
  }), {
    final: u.join(" "),
    initial: g.join(" ")
  ...
  const { final: i } = O(n);
  let h = "", g = "", u = "";
  return hi.indexOf(B(i)) !== -1 ? (h = i[0], g = i[1], u = i.slice(2)) : (g = i[0] || "", u = i.slice(1) || ""), { head: h, body: g, tail: u };
}, F = (n) => {
  const i = /(ā|ō|ē|ī|ū|ǖ|n̄|m̄|ê̄)/, h = /(á|ó|é|í|ú|ǘ|ń|ḿ|ế)/, g = /(ǎ|ǒ|ě|ǐ|ǔ|ǚ|ň|m̌|ê̌)/, u = /(à|ò|è|ì|ù|ǜ|ǹ|m̀|ề)/, s = /(a|o|e|i|u|ü|ê)/, e = /(n|m)$/, j = [];
  return n.split(" ").forEach((y) => {
    i.test(y) ? j.push("1") : h.test(y) ? j.push("2") : g.test(y) ? j.push("3") : u.test(y) ? j.push("4") : s.test(y) || e.test(y) ? j.push("0") : j.push("");
  }), j.join(" ");
}, Si = (n, i) => {
  const h = B(n).split(" "), g = F(i).split(" "), u = [];
  return h.forEach((s, e) => {
    u.push(`${s}${g[e]}`);
  }), u.join(" ");
}, Pn = (n, i) => {
  const h = [];
...
function vi(n, i, h) {
  ...
  if (i === h && i && Z(i) !== i)
    return B(Z(n));
  if (h && !si[n].includes(h)) {
    const g = Z(h);
    if (g !== h) {
      const u = F(g), s = Cn[n];
      for (let e in s)
        if (s[e].indexOf(Number(u)) !== -1)
          return e;
    }
  }
}
...
function Ii(n, i) {
  if (n === "々")
    return !i || !L.get(i) ? "tóng" : L.get(i).split(" ")[0];
}
function wn(n, i, h) {
  return Ii(n, i) || Pi(n, i) || vi(n, i, h) || Z(n);
}
const Ni = (n) => typeof n != "string" ? (console.error("The first param of pinyin is error: " + n + ' is not assignable to type "string".'), !1) : !0;
function V(n, i) {
...
const Di = (n, i) => {
  let h = i.nonZh;
  if (h === "removed")
    return n.filter((g) => g.isZh || !V(g.origin, i.nonZhScope));
  if (h === "consecutive") {
    for (let g = n.length - 2; g >= 0; g--) {
      const u = n[g], s = n[g + 1];
      !u.isZh && !s.isZh && V(u.origin, i.nonZhScope) && V(s.origin, i.nonZhScope) && (u.origin += s.origin, u.result += s.result, s.delete = !0);
    }
    return n.filter((g) => !g.delete);
  } else
    return n;
}, pn = (n, i) => I(n) === 1 && i.multiple ? Ci(n, i.surname) : !1, Li = (n, i) => {
  switch (i.pattern) {
    case "pinyin":
      break;
    case "num":
      n.forEach((h) => {
        h.result = h.isZh ? F(h.result) : "";
      });
      break;
    case "initial":
      n.forEach((h) => {
        h.result = h.isZh ? O(h.result, i.initialPattern).initial : "";
      });
      break;
    case "final":
      n.forEach((h) => {
        h.result = h.isZh ? O(h.result, i.initialPattern).final : "";
      });
      break;
    case "first":
      n.forEach((h) => {
        h.result = Pn(h.result, h.isZh);
      });
      break;
    case "finalHead":
      n.forEach((h) => {
        h.result = h.isZh ? $(h.result).head : "";
      });
      break;
    case "finalBody":
      n.forEach((h) => {
        h.result = h.isZh ? $(h.result).body : "";
      });
      break;
    case "finalTail":
      n.forEach((h) => {
        h.result = h.isZh ? $(h.result).tail : "";
      });
      break;
  }
}, Ti = (n, i) => {
  switch (i.toneType) {
    ...
    case "none":
      n.forEach((h) => {
        h.isZh && (h.result = B(h.result));
      });
      break;
    case "num": {
      n.forEach((h) => {
        h.isZh && (h.result = Si(h.result, h.originPinyin));
      });
      break;
    }
  }
  ...
  i.v && n.forEach((h) => {
    h.isZh && (h.result = h.result.replace(/ü/g, typeof i.v == "string" ? i.v : "v"));
  });
}, Ei = (n, i, h) => {
  if (i.multiple && I(h) === 1) {
    let g = "";
  ...
  return i.type === "array" ? n.map((g) => g.result) : i.type === "all" ? n.map((g) => {
    const u = g.isZh ? g.result : "", { initial: s, final: e } = O(u, i.initialPattern), { head: j, body: b, tail: y } = $(u);
    let x = [];
    return u !== "" && (x = [u].concat(vn(g.origin, i.surname).filter((k) => k !== u))), {
      origin: g.origin,
      pinyin: u,
      initial: s,
      final: e,
      first: Pn(g.result, g.isZh),
      finalHead: j,
      finalBody: b,
      finalTail: y,
      num: Number(F(g.originPinyin)),
      isZh: g.isZh,
      polyphonic: x,
      inZhRange: !!L.get(g.origin),
      result: g.result
    };
  }) : n.map((g) => g.result).join(i.separator);
}, Mi = (n, i) => (i === !1 && n.forEach((h) => {
...
function Zi(n, i) {
  if (i = Object.assign(Object.assign({}, Ri), i || {}), !Ni(n))
    return n;
  if (n === "")
  ...
  let g = Array(I(n)), { list: u } = _i(n, g, i.surname, i.segmentit, i.traditional);
  return u = Mi(u, i.toneSandhi), u = Di(u, i), pn(n, i) && (u = pn(n, i)), Li(u, i), Ti(u, i), Ai(u, i), Ei(u, i, n);
}
var X;
(function(n) {
...
X.AllSegment;
const Ui = "data:image/svg+xml,%3csvg%20width='20'%20height='20'%20viewBox='0%200%2020%2020'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M4.18359%2010.8864L7.93085%2014.6336C8.26642%2014.9692%208.81437%2014.9562%209.13359%2014.605L15.82%207.25'%20stroke='black'%20stroke-width='1.5'%20stroke-linecap='round'/%3e%3c/svg%3e", $i = "_modalContent_149um_2", Oi = "_modalHeader_149um_32", Bi = "_title_149um_37", Fi = "_cityMode_149um_44", Wi = "_citySelectArea_149um_54", Hi = "_cityMain_149um_69", Gi = "_header_149um_76", Ki = "_text_149um_80", Vi = "_label_149um_87", Qi = "_value_149um_91", Yi = "_cityBody_149um_99", Xi = "_cityScroll_149um_96", Ji = "_cityGroupItem_149um_118", nh = "_groupName_149um_118", ih = "_cityList_149um_127", hh = "_cityItem_149um_133", gh = "_active_149um_138", uh = "_activeIcon_149um_155", sh = "_cityLetter_149um_161", oh = "_letter_149um_180", th = "_footer_149um_203", ch = "_action_149um_212", lh = "_btnCancel_149um_216", zh = "_btnPrimary_149um_248", p = {
  modalContent: $i,
  modalHeader: Oi,
  title: Bi,
  cityMode: Fi,
  ...
  btnCancel: lh,
  btnPrimary: zh
}, eh = Tn("CitySelectModal"), qn = 300, xh = ({
  show: n,
  onClose: i,
  onConfirm: h,
  brand: g = 1,
  ...
  const [e, j] = R([]), b = nn(() => {
    ...
    return Gn.forEach((d) => {
      ...
      const m = (d.city_spell || d.__pinyin__).slice(0, 1).toUpperCase(), _ = o.get(m) || [];
      _.push(d), o.set(m, _);
    }), o;
  }, [e]), [y, x] = R(null), k = (o, d) => {
    ...
    if (typeof o == "string") {
      const m = o;
      return d.find((_) => _.show_name === m || _.name === m) ?? d.find((_) => _.show_name.replace("市", "") === m || _.name.replace("市", "") === m) ?? d.find((_) => m.startsWith(_.show_name.replace("市", "")) || m.startsWith(_.name.replace("市", ""))) ?? null;
    }
    return d.find((m) => m.show_name === o.show_name || m.show_name === o.name) ?? d.find((m) => m.name === o.name || m.name === o.show_name) ?? null;
  }, [q, S] = R(""), D = nn(() => y ? y.show_name.replace("市", "") : "", [y]), [v, W] = R(!1), E = M(0), c = M(null), z = (o) => {
    c.current = o, W(!0);
  }, l = M(null), t = M({}), a = M(0), f = (o) => {
    S(o);
    const d = document.getElementById(`group-${o}`);
    if (d && c.current) {
      const m = d.offsetTop - c.current.offsetTop;
      E.current = m, c.current.scrollTo({
        top: m,
        behavior: "smooth"
      });
    }
    ...
    () => {
      const o = c.current;
      if (!o) return;
      const d = Array.from(o.querySelectorAll('[id^="group-"]'));
      let m = "";
      for (const _ of d) {
        const r = _.getBoundingClientRect(), T = o.getBoundingClientRect();
        r.top - T.top <= 50 && (m = _.id.replace("group-", ""));
      }
      m && S(m), E.current = o.scrollTop;
    },
    { wait: qn }
  );
  return A(() => {
    if (n) {
      const o = k(s, e);
      x(o ?? (typeof s == "object" ? s : null));
    }
  }, [n]), A(() => {
    if (!n || !c.current) return;
    const o = c.current;
    return o.addEventListener("scroll", w.run), w.run(), () => {
      o.removeEventListener("scroll", w.run);
    };
  }, [v, w, n]), Dn(() => {
    n && v && c.current && E.current > 0 && c.current.scrollTo({
      top: E.current
    });
  }, [v, n]), A(() => {
    if (!n || !q || Date.now() < a.current) return;
    const o = l.current, d = t.current[q];
    if (!o || !d) return;
    const m = o.scrollHeight - o.clientHeight;
    if (m <= 0) return;
    const r = d.offsetTop - o.offsetTop - 20, T = Math.max(0, Math.min(m, r));
    ...
    if (!o) return;
    const d = () => {
      a.current = Date.now() + qn;
    };
    return o.addEventListener("wheel", d, { passive: !0 }), o.addEventListener("touchstart", d, { passive: !0 }), () => {
      o.removeEventListener("wheel", d), o.removeEventListener("touchstart", d);
    };
  }, [v, n]), A(() => {
    En.getCityList({ brand: g }).then((o) => {
      if (Array.isArray(o.cities) && o.cities.length > 0) {
        const d = o.cities.map((m) => ({
          ...m,
          __pinyin__: m?.city_spell ? "" : Zi(m.show_name, {
            toneType: "none",
            // 不要声调
            type: "string",
            // 返回字符串（默认）
        ...
        eh.warn("[getCityList] getCityList is empty");
    });
  }, [g]), /* @__PURE__ */ C(
    Mn,
    {
      className: `${p.modalContent} ${u}`,
      visible: n,
      onClose: i,
      pgid: "",
      pgname: "",
      children: /* @__PURE__ */ N(Ln, { children: [
        /* @__PURE__ */ C("div", { className: p.modalHeader, children: /* @__PURE__ */ C("div", { className: p.title, children: "选择城市" }) }),
        /* @__PURE__ */ N("div", { className: `${p.cityMode}`, children: [
          /* @__PURE__ */ N("div", { className: p.citySelectArea, children: [
            /* @__PURE__ */ N("div", { className: p.cityMain, children: [
              /* @__PURE__ */ N("div", { className: p.header, children: [
                /* @__PURE__ */ C("span", { className: `${p.text} ${p.label}`, children: "当前选择城市" }),
                /* @__PURE__ */ C("span", { className: `${p.text} ${p.value}`, children: D })
              ] }),
              /* @__PURE__ */ C("div", { className: p.cityBody, children: /* @__PURE__ */ C("div", { className: p.cityScroll, ref: z, children: Array.from(b.keys()).map((o) => /* @__PURE__ */ N("div", { className: p.cityGroupItem, id: `group-${o}`, children: [
                /* @__PURE__ */ C("span", { className: p.groupName, children: o }),
                (b.get(o) || []).length > 0 && /* @__PURE__ */ C("div", { className: p.cityList, children: (b.get(o) || []).map((d) => /* @__PURE__ */ N(
                  "div",
                  {
                    className: `${p.cityItem} ${y?.show_name === d.show_name && p.active}`,
                    children: [
                      /* @__PURE__ */ C(
                        "span",
                        {
                          ...
                          children: d.show_name
                        }
                      ),
                      y?.show_name === d.show_name && /* @__PURE__ */ C("img", { src: Ui, className: p.activeIcon })
                    ]
                  },
                  d.city_id
                )) })
            ...
            /* @__PURE__ */ C("div", { className: p.cityLetter, ref: l, children: Array.from(b.keys()).map((o) => /* @__PURE__ */ C(
              "span",
              {
                className: `${p.letter} ${q === o ? p.active : ""}`,
                ref: (d) => {
                  t.current[o] = d;
                },
                onClick: () => f(o),
          ...
          /* @__PURE__ */ C("div", { className: p.footer, children: /* @__PURE__ */ N("div", { className: p.action, children: [
            /* @__PURE__ */ C("button", { type: "button", className: p.btnCancel, onClick: i, children: "取消" }),
            /* @__PURE__ */ C(
              "button",
              {
                type: "button",
